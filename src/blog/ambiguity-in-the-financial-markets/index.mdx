...
<Figure source={props.localImages[0]} caption="Unstructured Data" />
...
<Figure source={props.localImages[3]} caption="Backtest" size={1200} />
...
<Figure source={props.localImages[7]} caption="Climate Risk" />
...
<Figure source={props.localImages[8]} caption="Differential Equations" />
