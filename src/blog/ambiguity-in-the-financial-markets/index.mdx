...
import ChartAmbiguity from "./charts/ambiguity";
...
<Figure source={props.localImages[1]} caption="Feature Selection" />
...
<Figure source={props.localImages[2]} caption="Financial Modeling" />
...
<Figure source={props.localImages[3]} caption="Backtest" />
...
<Figure source={props.localImages[4]} caption="Trading Strategies" />
...
<Figure source={props.localImages[5]} caption="Portfolio Optimization" />
...
<Figure source={props.localImages[6]} caption="Risk Management" />
...
<Figure source={props.localImages[9]} caption="Cryptocurrencies" />
