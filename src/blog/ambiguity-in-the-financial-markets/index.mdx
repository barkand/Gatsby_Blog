...
<Figure source={props.localImages[2]} caption="Backtest" size={600} />
...
<Figure source={props.localImages[8]} caption="Climate Risk" />
...
<Figure source={props.localImages[9]} caption="Differential Equations" />
